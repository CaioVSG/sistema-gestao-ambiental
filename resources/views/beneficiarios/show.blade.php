            ...
            <div class="col-sm-12">
                <div class="form-row">
                    <div class="col-md-8" style="padding-top: 15px;">
                        <h4 class="card-title">Visualizar Beneficiario nº {{$beneficiario->id}}</h4>
                        <h6 class="card-subtitle mb-2 text-muted"><a class="text-muted" href="{{route('beneficiarios.index', 'atuais')}}">Beneficiarios</a> > Visualizar Beneficiario nº {{$beneficiario->id}}</h6>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input id="name" class="form-control apenas_letras @error('name') is-invalid @enderror" type="text" name="name" value="{{$beneficiario->name}}" disabled autofocus autocomplete="name">
                                        </div>
